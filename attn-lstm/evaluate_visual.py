...
data_name = 'youcook_attnlstm_visual'
...
checkpoint = str(MODEL_DIR / 'BEST_checkpoint_quick-recipe-visual.pth.tar')  # model checkpoint
...
if __name__ == '__main__':
    ...
    val_loader = DataLoader(
        CaptionDataset(str(DATA_DIR), data_name, 'TEST', transform=None),
