...
data_name = 'youcook_attnlstm_multimodal'   # base name shared by data files
...
def main():
    ...
    global best_bleu4, best_topk_acc_val, epochs_since_improvement, checkpoint, start_epoch, fine_tune_encoder, data_name, word_map
    ...
    if checkpoint is None:
        decoder = DecoderWithAttention(attention_dim=attention_dim,
                                       ...
                                       encoder_dim=56, # img+textemb = (4,4,56)
        ...
        best_topk_acc_val = checkpoint['topk_acc_val']
    ...
    train_loader = DataLoader(
        # Custom dataset
        CaptionDatasetMultimodal(str(DATA_DIR), data_name, 'TRAIN', transform=None),
    ...
    val_loader = DataLoader(
        CaptionDatasetMultimodal(str(DATA_DIR), data_name, 'VAL', transform=None),
        batch_size=batch_size, shuffle=True, num_workers=workers, pin_memory=True)
    ...
    for epoch in range(start_epoch, epochs):
        ...
        recent_bleu4, recent_topk_acc_val = validate(
        ...
        is_best = recent_topk_acc_val > best_topk_acc_val
        best_topk_acc_val = max(recent_topk_acc_val, best_topk_acc_val)
        if not is_best:
